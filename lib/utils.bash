...
# NOTE: You might want to remove this if periphery is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if periphery has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert periphery executable exists.
		local tool_cmd
